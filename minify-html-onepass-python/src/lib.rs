use ::minify_html_onepass_fallback::in_place as minify_html_native;
use ::minify_html_onepass_fallback::Cfg;
use ::minify_html_onepass_fallback::Error;
...
#[pyfunction]
#[pyo3(signature = (code, minify_js = false, minify_css = false))]
